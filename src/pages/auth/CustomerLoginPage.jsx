...
export default function CustomerLoginPage() {
  ...
  return (
    ...
    <div className="text-center">
      ...
      <p className="mt-2 mb-7 text-body text-neutral-500">Sign in to your account.</p>
      ...
      <form onSubmit={handleSubmit} noValidate className="text-left space-y-4">
        ...
        <Button type="submit" variant="accent" pill className="w-full justify-center" size="lg" loading={loading}>
          Sign in
        </Button>
      </form>
      ...
      <div className="flex gap-2.5">
        <button
          type="button"
          className="flex flex-1 items-center justify-center gap-2 rounded-[12px] border border-neutral-200 bg-white px-4 py-2.5 text-small font-semibold text-neutral-700 hover:bg-neutral-50 transition-colors"
        >
          <GoogleIcon /> Google
        </button>
        <button
      ...
      <p className="mt-5 text-small text-neutral-500">
        New to LonApp?{' '}
        <Link to="/customer/onboard" className="font-bold text-accent-600 hover:underline">
          Create an account
        </Link>
      </p>
    </div>
